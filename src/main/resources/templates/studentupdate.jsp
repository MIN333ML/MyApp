...
<div id="testheader">
    <div class="container">
        <div class=row>
            <div class="col-md-5 ">
                <a href="MNU001.html"><h3>Student</h3></a>
            </div>
            <div class="col-md-6">
                <p style="color:black"
        ...
        <label for="file" id="file-label" class="file-label">
            <div th:each="photo : ${list}">
                <div th:if="${photo.studentid == #session.getAttribute('id')}">
                    ...
                    <img th:if="${photo.image != null}" th:src="@{/image/{imagename}(imagename=${photo.image})}"
                         id="output">
                </div>
            </div>
        </label>
...
<div id="sub_content">
    <form action="studentup" method="post" th:object="${std}" enctype="multipart/form-data">
        <h2 class="col-md-6 offset-md-2 mb-5 mt-4">Student Registration</h2>

        <div class="row mb-4">
            <div class="col-md-2"></div>
            <div class="col-md-4">
                <input type="hidden" th:field="*{studentid}" class="form-control" id="studentID" disabled="true"/>
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-2"></div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <span th:text="${std.education}"></span>
            </div>
        </div>
        <fieldset class="row mb-4">
            <div class="col-md-2"></div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                ...
                <a style="background-color:green;" class="btn btn-danger" th:href='@{studentseartch}'>
                    <span>Back</span>
                </a>
