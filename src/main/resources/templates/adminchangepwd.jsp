...
<div class="container">
    <div class="sidenav">
        ...
        <span th:each="data : ${list}">
                <span th:if="${data.userid == session.userid}">
...
<div class="main_contents">
    <div id="sub_content">
        <form action="adminnewpwd1" method="post" th:object="${pwd1}" enctype="multipart/form-data" class="user-form"
              onsubmit="return validateForm()">

            <h2 class="col-md-6 offset-md-2 mb-5 mt-4" style="color:black;">Change Admin Password</h2>
            <div class="row mb-4">
                <div class="col-md-2"></div>
                <div class="col-md-4">
                    <input type="hidden" class="form-control" th:field="*{userid}" id="id" value="${pwd1.userid}"/>
                </div>
            </div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="password" class="form-control" id="oldpassword1" name="password" th:field="*{password}"
                           onfocus="clearError('error'); clearError('error4')" onblur="validateOldPwd()"/>
                    <span id="error" style="color:red;"></span>
                    <span id="error4" style="color:red;" th:text="${#strings.capitalize(#vars['oldpwderor'])}"></span>
