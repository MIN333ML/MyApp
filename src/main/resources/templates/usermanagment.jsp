...
<div class="main_contents">
    <div id="sub_content">
        <form class="row g-3 mt-3 ms-2" action="searchname" method="get">

            <div class="col-auto">
                <label for="inputPassword2" class="visually-hidden">User Name</label>
                <input type="text" name="searchname" class="form-control" id="inputPassword2" placeholder="User Name"/>
            </div>
        ...
        <table class="table table-striped" id="stduentTable">
            ...
            <tr th:each="data, status: ${list22}" th:object="${data}">
                <td th:text="${status.index +1}">${loop.index + 1 }</td>
                <td th:text="${data.name}"></td>
                <td>
                    <a type="button" class="btn btn-success  " th:href='@{setupUpdatebook1(id=${data.userid})}'>
                        View Details
                    </a>
                </td>
